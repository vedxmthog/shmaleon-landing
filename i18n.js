...
(function () {
  ...
  var SHM_TRANSLATIONS = {
    en: {
      ...
      intensity_profound_note: ' (1,000mg cannabis-infused botanical extract)',
      ...
      channel_option_telegram: 'Telegram',
      channel_option_instagram: 'Instagram',
      channel_option_whatsapp: 'WhatsApp',
      channel_option_email: 'Email',
    ...
    ru: {
      ...
      intensity_profound_note: ' (1 000 мг, ботанический экстракт с каннабисом)',
    ...
    th: {
      ...
      intensity_profound_note: ' (สารสกัดพฤกษศาสตร์ผสมกัญชา 1,000 มก.)',
